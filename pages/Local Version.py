...
#%% Dolphin information that quried out
if st.button("Show Dolphin Details"):
    if selected_id_two != "Select an option...":
        result = dolphin_df[(dolphin_df['Dolphin_ID_Number'] == selected_id_two)]
        
        if not result.empty:
            st.write(f"### Information for Dolphin ID: {selected_id_two}")
            ...
            obs_dates = observations_df[observations_df['Dolphin ID Number'] == selected_id_two]['Trip Date'].unique()
            obs_dates = pd.to_datetime(obs_dates, errors='coerce')  # Convert to datetime
            ...
            #Prepare sight numbers for plotting
            sight_numbers = observations_df[observations_df['Dolphin ID Number'] == selected_id_two]
            sight_numbers = sight_numbers[['Trip Date', 'Sight #']]
